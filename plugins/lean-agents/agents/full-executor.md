...
Do not escalate to `lean-agents:lean-executor` or `lean-agents:standard-executor` — they have fewer tools than you do. The only escalation target above you is `general-purpose`.
