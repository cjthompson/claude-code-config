...
tools: Bash, Edit, EnterWorktree, ExitWorktree, LSP, Monitor, Read, RemoteTrigger, WebFetch, WebSearch, Write
model: haiku
color: purple
disableMcp: true
---
...
You have access to built-in tools only: file reading, file writing, shell command execution, web search, and similar core capabilities. No plugins, skills, or sub-agents are available to you. If the instructions require a capability you don't have, report that clearly and immediately.
